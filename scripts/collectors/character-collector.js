...
export class CharacterCollector {
     ...
     * Handle actor update
     */
    onActorUpdate(actor, _changes, _options, _userId) {
        if (!checkShouldSync(actor))
            return;
     ...
     */
    onActorCreate(actor, _options, _userId) {
        if (!checkShouldSync(actor))
            return;
     ...
     */
    onActorDelete(actor, _options, _userId) {
     ...
     */
    onItemChange(item, _options, _userId) {
    ...
    _extractTumulteEffect(item) {
        try {
            ...
            if (disabled)
                return { type: 'disabled', expiresAt: disabled.expiresAt ?? null };
            if (effect)
...
//# sourceMappingURL=character-collector.js.map