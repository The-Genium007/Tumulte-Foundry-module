...
/** A dictionary mapping localized names to normalized keys */
type LocalizationDict = Record<string, string>

/** Mappings for a single language within a system */
export interface LanguageMappings {
  skills: LocalizationDict
  abilities: LocalizationDict
  rollTypes: LocalizationDict
}

/** Mappings for all supported languages within a system */
type SystemLanguageMappings = Record<string, LanguageMappings>

// ============================================================================
// TIER S - Top 10 Most Popular Systems
// ============================================================================

const DND5E_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
...
const PF2E_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
      'acrobatics': 'acrobatics',
      'arcana': 'arcana',
...
const PF1_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
      'acrobatics': 'acrobatics',
      'appraise': 'appraise',
...
const WFRP4E_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
      // Basic Skills
      'athletics': 'athletics',
...
const LANCER_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
...
const CYBERPUNK_RED_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
      'athletics': 'athletics',
      'brawling': 'brawling',
...
const COC7_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
      'accounting': 'accounting',
...
const SWADE_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
      'academics': 'academics',
      'athletics': 'athletics',
...
const STARFINDER_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
      'acrobatics': 'acrobatics',
      'athletics': 'athletics',
...
const STAR_WARS_FFG_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
      // General Skills
...
const WOD5E_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
      // Physical
      'athletics': 'athletics',
...
const ALIEN_RPG_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
...
const WRATH_AND_GLORY_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
      'athletics': 'athletics',
      'awareness': 'awareness',
...
const DELTA_GREEN_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
      'accounting': 'accounting',
      'alertness': 'alertness',
...
const FORBIDDEN_LANDS_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
      'might': 'might',
      'endurance': 'endurance',
...
const BLADES_IN_THE_DARK_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
      // Insight
      'hunt': 'hunt',
...
const MORK_BORG_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
      'agility': 'agility',
      'presence': 'presence',
...
const VAESEN_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
      'agility': 'agility',
      'close combat': 'close_combat',
...
const KULT_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
      // Moves
...
const CAIRN_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {},
    abilities: {
      'strength': 'str',
...
const MOTHERSHIP_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
      // Combat
      'combat': 'combat',
...
const DUNGEON_WORLD_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
...
const FATE_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
      'athletics': 'athletics',
      'burglary': 'burglary',
...
const OSE_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
...
const SHADOW_OF_DEMON_LORD_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {},
    abilities: {
      'strength': 'str',
...
const IRONSWORN_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {
...
const GENERIC_MAPPINGS: SystemLanguageMappings = {
  en: {
    skills: {},
    abilities: {
      'strength': 'str',
...
export const SYSTEM_MAPPINGS: Record<string, SystemLanguageMappings> = {
  // Tier S
 ...
 */
export function getSystemMappings(systemId: string, language: string = 'en'): LanguageMappings {
